  ...
  return (
    <div className={cn(
      ...
      <div className="border-t bg-muted/20 px-5 py-2.5">
        <p className="text-[11px] text-muted-foreground">Posted {date} · by PrepIQ</p>
      </div>
    </div>
  )
}
    ...
    <div className="space-y-6">
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border bg-background py-16 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground/70">Check back soon — PrepIQ is cooking something 🔥</p>
        </div>
      ) : (
