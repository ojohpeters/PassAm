    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-6 text-center">
        <div className="flex justify-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-rose-100 dark:bg-rose-950/50">
        ...
        <form action={signOutAction}>
          <button
            type="submit"
            className="w-full rounded-xl border py-3 text-sm font-semibold text-muted-foreground transition-all hover:bg-muted"
          >
            Sign Out
          </button>
        </form>
